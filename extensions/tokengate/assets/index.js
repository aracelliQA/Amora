...
const r$1 = /* @__PURE__ */ getDefaultExportFromCjs(react.exports);
...
function Ne(e2, n2, r2, o) {
  ...
  return e2 instanceof ve ? r2 ? (e2.inject(r2, o), e2.getName(o)) : e2 : S(e2) ? function e3(t2, n3) {
    var r3, o2, s2 = [];
    for (var i2 in t2)
      t2.hasOwnProperty(i2) && !_e(t2[i2]) && (Array.isArray(t2[i2]) && t2[i2].isCss || b(t2[i2]) ? s2.push(be(i2) + ":", t2[i2], ";") : S(t2[i2]) ? s2.push.apply(s2, e3(t2[i2], i2)) : s2.push(be(i2) + ": " + (r3 = i2, null == (o2 = t2[i2]) || "boolean" == typeof o2 || "" === o2 ? "" : "number" != typeof o2 || 0 === o2 || r3 in unitlessKeys$1 ? String(o2).trim() : o2 + "px") + ";"));
...
function Fe(e2) {
  ...
  return e2.children ? r$1.createElement(Ge.Provider, { value: n2 }, e2.children) : null;
}
var Ye = {};
  ...
  var C2, I2 = new se(n2, g2, o ? e2.componentStyle : void 0), P2 = I2.isStatic && 0 === c2.length, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      var f3 = function(e5, t5, n4) {
        ...
        return i3;
      }(i2, r2, y2), w2 = n3, _24 = g3.$as || t4.$as || g3.as || t4.as || p3, N2 = ke(_24), A3 = g3 !== t4 ? v({}, t4, {}, g3) : t4, C3 = {};
      for (var I3 in A3)
        "$" !== I3[0] && "as" !== I3 && ("forwardedAs" === I3 ? C3.as = A3[I3] : (d3 ? d3(I3, isPropValid$1, _24) : !N2 || isPropValid$1(I3)) && (C3[I3] = A3[I3]));
      return t4.style && g3.style !== t4.style && (C3.style = v({}, t4.style, {}, g3.style)), C3.className = Array.prototype.concat(c3, h3, S3 !== h3 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C3.ref = w2, react.exports.createElement(_24, C3);
    }(C2, e3, t3, P2);
  };
...
function We(e2) {
  for (var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), o = 1; o < t2; o++)
    n2[o - 1] = arguments[o];
  var i = Ce.apply(void 0, [e2].concat(n2)), a = "sc-globalThis-" + xe(JSON.stringify(i)), u2 = new $e(i, a);
  function l2(e3) {
...
var HeadingLg = Ce`
  ...
  font-weight: ${({ $bold, theme }) => $bold && theme.typography.headingLg.fontWeightBold ? theme.typography.headingLg.fontWeightBold : theme.typography.headingLg.fontWeight};
...
var HeadingMd = Ce`
  ...
  font-weight: ${({ $bold, theme }) => $bold && theme.typography.headingMd.fontWeightBold ? theme.typography.headingMd.fontWeightBold : theme.typography.headingMd.fontWeight};
...
var HeadingSm = Ce`
  ...
  font-weight: ${({ $bold, theme }) => $bold && theme.typography.headingSm.fontWeightBold ? theme.typography.headingSm.fontWeightBold : theme.typography.headingSm.fontWeight};
...
var BodyLg = Ce`
  ...
  font-weight: ${({ $bold, theme }) => $bold && theme.typography.bodyLg.fontWeightBold ? theme.typography.bodyLg.fontWeightBold : theme.typography.bodyLg.fontWeight};
  line-height: ${({ theme }) => theme.typography.bodyLg.lineHeight};
`;
var BodyMd = Ce`
  font-family: ${({ theme }) => theme.typography.bodyMd.fontFamily};
  font-size: ${({ theme }) => theme.typography.bodyMd.fontSize};
  font-weight: ${({ $bold, theme }) => $bold && theme.typography.bodyMd.fontWeightBold ? theme.typography.bodyMd.fontWeightBold : theme.typography.bodyMd.fontWeight};
  line-height: ${({ theme }) => theme.typography.bodyMd.lineHeight};
`;
var BodySm = Ce`
  font-family: ${({ theme }) => theme.typography.bodySm.fontFamily};
  font-size: ${({ theme }) => theme.typography.bodySm.fontSize};
  font-weight: ${({ $bold, theme }) => $bold && theme.typography.bodySm.fontWeightBold ? theme.typography.bodySm.fontWeightBold : theme.typography.bodySm.fontWeight};
  line-height: ${({ theme }) => theme.typography.bodySm.lineHeight};
`;
var CriticalColor = Ce`
  color: ${({ theme }) => theme.typography.colorCritical};
`;
var DisabledColor = Ce`
  color: ${({ theme }) => theme.typography.colorDisabled};
`;
var PrimaryColor = Ce`
  color: ${({ theme }) => theme.typography.colorPrimary};
`;
var SecondaryColor = Ce`
  color: ${({ theme }) => theme.typography.colorSecondary};
`;
var ColorMappedToCSS = {
  critical: CriticalColor,
  disabled: DisabledColor,
  primary: PrimaryColor,
  secondary: SecondaryColor
};
var VariantMappedToCSS = {
  bodyLg: BodyLg,
  bodyMd: BodyMd,
  bodySm: BodySm,
  headingLg: HeadingLg,
...
var Text = ({
  ...
  return /* @__PURE__ */ jsx(Wrapper, { as, color, variant, $bold: bold, children });
};
...
var PrimaryButtonWrapper = Ce`
  ...
  &:hover {
    background-color: ${({ theme }) => theme.buttons.variants.primary.hover.background};
    box-shadow: ${({ theme }) => theme.buttons.variants.primary.hover.boxShadow};
  }
`;
var SecondaryButtonWrapper = Ce`
  ...
  &:hover {
    background-color: ${({ theme }) => theme.buttons.variants.secondary.hover.background};
    box-shadow: ${({ theme }) => theme.buttons.variants.secondary.hover.boxShadow};
  }
`;
var DisabledButtonWrapper = Ce`
  cursor: default;
...
var Button = ({
  ...
  return /* @__PURE__ */ jsx(
    ButtonWrapper,
    {
      ...
      type: "button",
      ...wrapperProps,
      children: loading ? /* @__PURE__ */ jsx(Spinner_default, {}) : /* @__PURE__ */ jsx(Text, { as: "label", bold: true, variant: sizeMappedToTextVariant[size], children: label })
    }
  );
};
styled.button`
...
`;
var RootProvider = ({ children, theme = "Default" }) => {
  const providedTheme = typeof theme === "string" ? AvailableThemes[theme] : theme;
  return /* @__PURE__ */ jsxs(Fe, { theme: providedTheme, children: [
    /* @__PURE__ */ jsx(GlobalStyles, {}),
    children
  ] });
};
var formatWalletAddress = (address) => `${address.substring(0, 4)}...${address.substring(address.length - 4)}`;
var AvailableSoonButton_default = {
  buttonText: "Starts {{date}}"
};
var SoldOutButton_default = {
  buttonText: "Sold out",
  description: "Check back later for stock updates"
};
var Tokengate_default = {
  exclusive: {
    ...
    unlocked: {
      ...
      subtitleWithOrderLimit: "You can buy up to {{orderLimit}} with your tokens."
    }
  },
  discount: {
    locked: {
      title: "{{discount}} holder discount",
  ...
  errors: {
    ...
    missingTokensError: "You don't have a required token.\nDisconnect to try another wallet."
  }
};
...
var i18n = createInstance({
  ...
  resources: {
    en: {
      AvailableSoonButton: AvailableSoonButton_default,
      SoldOutButton: SoldOutButton_default,
...
function useTranslation(namespace, options) {
  return useTranslation$1(namespace, { ...options, i18n: i18n_default });
}
function convert(availableDate) {
  if (!availableDate)
    return;
...
var AvailableSoonButton = ({ availableDate }) => {
  const { t: t2 } = useTranslation("AvailableSoonButton");
  return /* @__PURE__ */ jsx(
    Button,
    {
      "aria-label": t2("buttonText", {
...
var Card = ({ title, subtitle, button, children }) => {
  return /* @__PURE__ */ jsxs(StyledCard, { id: "shopify-tokengate-card-container", children: [
    /* @__PURE__ */ jsx(Text, { as: "h2", variant: "headingMd", children: title }),
    /* @__PURE__ */ jsx(SubtitleWrapper, { children: /* @__PURE__ */ jsx(Text, { as: "span", variant: "bodyMd", color: "secondary", children: subtitle }) }),
    children,
    button
  ] });
};
...
`;
var SoldOutButton = () => {
  const { t: t2 } = useTranslation("SoldOutButton");
  return /* @__PURE__ */ jsxs(Wrapper3, { children: [
    /* @__PURE__ */ jsx(
      Button,
      {
        "aria-label": t2("buttonText"),
...
var TokenBase = ({
  ...
  badge,
  rightContent
}) => /* @__PURE__ */ jsxs(TokenBaseStyle, { children: [
  /* @__PURE__ */ jsxs(TokenBaseIcon, { round, children: [
    icon,
    /* @__PURE__ */ jsx(TokenBaseBadge, { children: badge })
  ] }),
  /* @__PURE__ */ jsxs(TokenBaseText, { children: [
    /* @__PURE__ */ jsx(Text, { as: "p", variant: "bodyLg", children: title }),
    /* @__PURE__ */ jsx(Text, { as: "p", variant: "bodyMd", color: "secondary", children: subtitle })
  ] }),
  rightContent
] });
var TokenBaseSkeleton = ({ round }) => /* @__PURE__ */ jsxs(TokenBaseStyle, { children: [
...
var TokenListWrapper = styled.div`
  ...
  box-sizing: unset;
`;
var TokenListImage = ({ alt, imageUrl }) => {
  if (!imageUrl) {
    return /* @__PURE__ */ jsx(SkeletonThumbnail, {});
  }
  return /* @__PURE__ */ jsx(TokenListImageStyle, { src: imageUrl, alt });
};
var TokenListSkeleton = ({ round }) => /* @__PURE__ */ jsx(TokenBaseSkeleton, { round });
var TokenList = ({ tokens, separator, isLoading }) => {
  if (isLoading) {
    return /* @__PURE__ */ jsx(TokenListWrapper, { children: /* @__PURE__ */ jsx(TokenListSkeleton, { round: true }) });
  }
  return /* @__PURE__ */ jsx(TokenListWrapper, { children: tokens == null ? void 0 : tokens.map(
    ({ title, subtitle, imageUrl, badge, round, rightContent }, index) => /* @__PURE__ */ jsxs(react.exports.Fragment, { children: [
      /* @__PURE__ */ jsx(
        TokenBase,
        {
          title,
          subtitle,
          round: Boolean(round),
          icon: /* @__PURE__ */ jsx(TokenListImage, { imageUrl, alt: title }),
          badge,
          rightContent
        }
      ),
...
var TokengateRequirementsSeparator = ({
  logic
}) => /* @__PURE__ */ jsx(TokengateRequirementsSeparatorStyle, { $gap: logic ? "12px" : "0px", children: logic ? /* @__PURE__ */ jsx(Text, { as: "span", variant: "bodySm", children: logic === "ALL" ? "AND" : "OR" }) : null });
var CrossBadge = () => /* @__PURE__ */ jsxs("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "currentColor", children: [
  ...
  /* @__PURE__ */ jsx(
    "path",
    {
      fillRule: "evenodd",
      clipRule: "evenodd",
      d: "M0 7C0 3.13401 3.13401 0 7 0C10.866 0 14 3.13401 14 7C14 10.866 10.866 14 7 14C3.13401 14 0 10.866 0 7ZM7.00008 7.99009L4.6952 10.295L3.70525 9.30503L6.01014 7.00014L3.70497 4.69497L4.69492 3.70502L7.00008 6.01019L9.30525 3.70502L10.2952 4.69497L7.99003 7.00014L10.2949 9.30503L9.30497 10.295L7.00008 7.99009Z",
      fill: "#D72C0D"
    }
  )
] });
var TokengateRequirementsBadge = () => {
  return /* @__PURE__ */ jsx(TokengateRequirementsBadgeWrapper, { children: /* @__PURE__ */ jsx(CrossBadge, {}) });
};
var mapRequirementsToTokenListProps = ({
  requirements,
  unlockingTokens,
  hasMissingTokens,
  t: t2
}) => requirements == null ? void 0 : requirements.conditions.map((condition) => {
  var _a;
  let badge;
  if (hasMissingTokens) {
    ...
    badge = (unlockingTokens == null ? void 0 : unlockingTokens.length) !== void 0 && !unlockingTokenForCurrentCondition && /* @__PURE__ */ jsx(TokengateRequirementsBadge, {});
  }
  return {
    title: (_a = condition.name) != null ? _a : `contract ${formatWalletAddress(condition.collectionAddress)}`,
    subtitle: t2("conditionDescription.any"),
    imageUrl: condition.imageUrl,
    badge,
    round: true
  };
});
var findUnlockingTokenForCondition = ({
  condition,
  unlockingTokens
}) => unlockingTokens == null ? void 0 : unlockingTokens.find(
  (unlockingToken) => unlockingToken.collectionAddress === condition.collectionAddress
);
var TokengateRequirements = ({
  ...
  const { t: t2 } = useTranslation("TokengateRequirements");
  ...
  return /* @__PURE__ */ jsx(
    TokenList,
    {
      isLoading,
      tokens: items,
      separator: /* @__PURE__ */ jsx(TokengateRequirementsSeparator, { logic: requirements == null ? void 0 : requirements.logic })
    }
  );
};
var OrderLimit = ({
  ...
  return /* @__PURE__ */ jsx(Text, { as: "span", variant: "bodySm", color: "secondary", children: markup });
};
var mapUnlockingTokensToTokenListProps = ({
  unlockingTokens,
  redemptionLimit
}) => unlockingTokens == null ? void 0 : unlockingTokens.map((unlockingToken) => ({
  ...
  totalOrderLimit: redemptionLimit == null ? void 0 : redemptionLimit.total,
  rightContent: /* @__PURE__ */ jsx(
    OrderLimit,
    {
      consumedOrderLimit: unlockingToken.consumedRedemptionLimit,
      limitPerToken: redemptionLimit == null ? void 0 : redemptionLimit.perToken
    }
  )
}));
var UnlockingTokens = ({
  ...
  return /* @__PURE__ */ jsx(TokenList, { tokens });
};
var useTokengateCardState = (tokengateProps) => {
  return {
    sections: getSections(tokengateProps),
    ...useTitleAndSubtitle(tokengateProps)
  };
};
var getSections = (tokengateProps) => {
  const isLocked = calculatedIsLocked(tokengateProps);
  const { active, isSoldOut, isConnected, unlockingTokens, isLoading } = tokengateProps;
  if (isLoading) {
    return [
      "TokengateRequirementSkeleton",
      "ConnectWallet"
    ];
  }
  ...
  const now = new Date();
  const dateObject = (active == null ? void 0 : active.start) ? new Date(active.start) : null;
...
var useTokengateI18n = (props) => {
  const isLocked = calculatedIsLocked(props);
  const { t: t2 } = useTranslation("Tokengate");
  ...
  return (key, vars) => t2(`${i18nKeyPrefix}.${key}`, vars);
};
var useTitleAndSubtitle = (props) => {
  var _a, _b;
  ...
  const customTitles = isDiscountGate(props) ? discountCustomTitles : exclusiveCustomTitles;
  const {
    lockedTitle,
    lockedSubtitle,
    unlockedTitle,
  ...
  } = customTitles != null ? customTitles : {};
  const customTitle = isLocked ? lockedTitle : unlockedTitle;
  const customSubtitle = isLocked ? lockedSubtitle : unlockedSubtitle;
  const discountText = ((_a = reaction == null ? void 0 : reaction.discount) == null ? void 0 : _a.type) === "percentage" ? `${reaction.discount.value}%` : `$${(_b = reaction == null ? void 0 : reaction.discount) == null ? void 0 : _b.value}`;
  const title = customTitle || translateTokengateI18n("title", { discount: discountText });
  let subtitle = customSubtitle || translateTokengateI18n("subtitle", {
    hasRedemption
  });
  if (hasRedemption && !isLocked) {
    subtitle = unlockedSubtitleWithRedemptionLimit || translateTokengateI18n("subtitleWithOrderLimit", {
...
var getCombinedConsumedOrderLimit = ({ unlockingTokens }) => {
  const initialValue = 0;
  const combinedConsumedOrderLimit = unlockingTokens == null ? void 0 : unlockingTokens.reduce(
  ...
  return combinedConsumedOrderLimit && combinedConsumedOrderLimit > 0 ? combinedConsumedOrderLimit : void 0;
};
var hasReachedOrderLimit = (props) => {
  var _a;
  const orderLimit = (_a = props.redemptionLimit) == null ? void 0 : _a.total;
...
var isDiscountGate = (props) => {
  var _a;
  return ((_a = props.reaction) == null ? void 0 : _a.type) === "discount" && props.reaction.discount;
};
var calculatedIsLocked = (props) => {
  const { unlockingTokens, requirements, isConnected, isLocked } = props;
  if (isLocked !== void 0)
    return isLocked;
  if (!isConnected || !unlockingTokens || unlockingTokens.length === 0)
    return true;
  const arrayLogicFunction = (requirements == null ? void 0 : requirements.logic) === "ALL" ? "every" : "some";
  const hasTokenForAllConditions = requirements == null ? void 0 : requirements.conditions[arrayLogicFunction](
    (condition) => Boolean(
      unlockingTokens.find(
        (unlockingToken) => unlockingToken.collectionAddress.toLowerCase() === condition.collectionAddress.toLowerCase()
      )
    )
  );
...
var Tokengate = (props) => {
  ...
  const sectionMapping = react.exports.useMemo(
    () => ({
      ...
      ["ConnectedWallet"]: connectedButton != null ? connectedButton : connectButton,
      ["UnlockingTokens"]: /* @__PURE__ */ jsx(
        UnlockingTokens,
        {
          unlockingTokens,
          redemptionLimit
      ...
      ["TokengateRequirement"]: /* @__PURE__ */ jsx(TokengateRequirements, { requirements }),
      ["TokengateRequirementMissingTokens"]: /* @__PURE__ */ jsx(
      ...
      ["AvailableSoon"]: /* @__PURE__ */ jsx(AvailableSoonButton, { availableDate: active == null ? void 0 : active.start }),
      ["SoldOut"]: /* @__PURE__ */ jsx(SoldOutButton, {}),
      ["TokengateRequirementSkeleton"]: /* @__PURE__ */ jsx(TokengateRequirements, { isLoading: true }),
      ["OrderLimitReachedError"]: /* @__PURE__ */ jsx(Error$1, { text: t2("errors.orderLimitReachedError") }),
      ["MissingTokensError"]: /* @__PURE__ */ jsx(Error$1, { text: t2("errors.missingTokensError") })
    }),
    [
      active == null ? void 0 : active.start,
      connectButton,
      connectedButton,
      requirements,
      t2,
  ...
  return /* @__PURE__ */ jsx(Card, { title, subtitle, children: sections.map((section) => /* @__PURE__ */ jsx(react.exports.Fragment, { children: sectionMapping[section] }, section)) });
};
var TokengateProvider = (props) => {
  return /* @__PURE__ */ jsx(I18nextProvider, { i18n: i18n_default, children: /* @__PURE__ */ jsx(RootProvider, { theme: props.theme, children: /* @__PURE__ */ jsx(Tokengate, { ...props }) }) });
};
function _extends() {
